...
# draining stdin does NOT make us take SIGPIPE. claude, codex, opencode, copilot, and
# agency were verified to read the full prompt from stdin; agy (Google Antigravity CLI)
# is wired by analogy to its gemini-cli lineage but not yet live-verified — see the note
